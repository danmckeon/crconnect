FactoryGirl.define do
  factory :trial do
    nct_id "NCT01622621"
    phase "Phase 2"
    sponsor_name "Mayo Clinic"
    sponsor_type "Other"
    study_title "Randomized Phase II Trial of Stereotactic Body Radiotherapy (SBRT) Versus Sublobar Resection for High-Risk Patients With Early Stage Non-Small Lung Cancer (NSCLC)"
    cohort "1"
    age_min "18"
    age_max "150"
    ...
    marker_egfr_mutation nil
    marker_kras_mutation nil
    treatment_radiation nil
    treatment_radiation_exclusion_period_mo nil
    treatment_chemo_systemic nil
    treatment_chemo_systemic_exclusion_period_mo nil
    treatment_chemo_adjuvant nil
    treatment_chemo_adjuvant_exclusion_period_mo nil
    treatment_tki nil
    treatment_tki_exclusion_period_mo nil
