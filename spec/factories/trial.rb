FactoryGirl.define do
  ...
  factory(:excited_submit, class: Trial) do
    nct_id "NCT0199213814"
    phase "Phase 3"
    brief_title "Fairly important study"
    cohort "1"
    minimum_age "18"
    maximum_age "150"
    type_lung_nsclc_adeno "nil"
    type_lung_nsclc_large "nil"
    type_lung_nsclc_squamous "nil"
    type_lung_sclc "nil"
    type_colorectal_adeno "include"
    type_colorectal_nonadeno "include"
    stage_ii "include"
    stage_iii "include"
    treatment_chemo_systemic "exclude"
    status_relapse nil
