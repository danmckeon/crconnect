            ...
            <div className="panel-body search-form-body">
              ...
              <form className="search-form form-group" onSubmit={(e) => this.onSubmit(e)}>
                <div className="row">
                  ...
                  <label className="search-field-label" htmlFor="chemotherapy">Is chemotherapy your main form of treatment?</label>
                  ...
                  <label className="search-field-label" htmlFor="cancerStatus">If you have received treatment, what is the current status of your condition?</label>
