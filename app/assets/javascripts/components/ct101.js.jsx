class CT101 extends React.Component {
  copyText(activeTab) {
    if(activeTab === "q1"){
                          return "Clinical trials offer the opportunity to receive new cancer treatments that may not otherwise be available. When you participate in a clinical trial for a cancer treatment, you receive the treatment under study or the best available standard treatment. Unlike clinical studies in other fields, patients in cancer trials only receive a placebo if no standard treatment already exists. Cancer is one of the most active areas in medical research today. Thousands of clinical trials are underway on new cancer drugs and treatments right now. There may be multiple trials available nearby you."
    } else if(activeTab === "q2"){
                                  return "Patients in cancer clinical trials receive increased monitoring and attention from nurses and doctors due to being in the trial.  Other benefits include: 1) You may receive access to cutting edge treatments that aren’t available anywhere else. 2) It offers another option if your cancer has become resistant to treatment or has reoccurred. 3) You can help further medical research not only for yourself but for other cancer patients as well."
                                  ...
                                  return "Informed consent is your right as a clinical trial participant. You must be provided with an outline of the purpose of the study, the exact treatment you will receive, and all possible side effects. In addition, it is your right to withdraw at any point, even after granting consent."
    } else if(activeTab === "q5") {
                                  return "You can use our search tool below to find clinical trials for which you could be eligible. If you find one you are interested in participating in, consult your doctor to see if it is a good fit for you and contact the listed study coordinator."
    }
  }
